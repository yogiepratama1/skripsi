...
<head>
    ...
    <?php if(request()->is("dashboard/permintaans") || request()->is("dashboard/permintaans/*")): ?>
        <title>Permintaan</title>
    <?php elseif(request()->is("dashboard/pembayaran") || request()->is("dashboard/pembayaran/*")): ?>
        <title>Pembayaran</title>
    <?php elseif(request()->is("dashboard/assets/*") || request()->is("dashboard/assets")): ?>
        <title>Barang</title>
    <?php else: ?>
        <title>Laporan</title>
    <?php endif; ?>
    ...
    <link href="<?php echo e(asset('css/jquery-datatable.css')); ?>" rel="stylesheet" />
    <link href="<?php echo e(asset('css/datatable.bootstrap4.min.css')); ?>" rel="stylesheet" />
    <link href="<?php echo e(asset('css/select.datatable.min.css')); ?>" rel="stylesheet" />
    <link href="<?php echo e(asset('css/buttons.datatable.min.css')); ?>" rel="stylesheet" />
    ...
    <link rel="icon" href="<?php echo e(asset('logo-perusahaan.png')); ?>" type="image/x-icon">
...
<body class="sidebar-mini layout-fixed" style="height: auto;">
    <div class="wrapper">
        <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    ...
                    <img src="<?php echo e(asset('icons/arrow-left-solid.svg')); ?>" alt="book" width="20px" height="20px">
                    </a>
                </li>
            </ul>
        ...
        <footer class="main-footer">
            <strong> &copy;</strong> Sistem Informasi Pendaftaran Peserta Pensiun
        </footer>
    </div>
    ...
    <script src="<?php echo e(asset('js/jquery.datatable.min.js')); ?>"></script>
    <script src="<?php echo e(asset('js/datatable.bootstrap4.min.js')); ?>"></script>
    <script src="<?php echo e(asset('js/datatable.buttons.min.js')); ?>"></script>
    <script src="<?php echo e(asset('js/datatable.buttons.flash.min.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('js/datatable.buttons.colvis.min.js')); ?>"></script>
    <script src="<?php echo e(asset('js/datatable.select.min.js')); ?>"></script>
    <script src="<?php echo e(asset('js/bootstrap-datetimepicker.min.js')); ?>"></script>
    <script src="<?php echo e(asset('js/dropzone.min.js')); ?>"></script>
    <script src="<?php echo e(asset('js/jszip.js')); ?>"></script>
...
</html><?php /**PATH C:\xampp\htdocs\skripsi\resources\views/layouts/admin.blade.php ENDPATH**/ ?>