...
Route::group(['prefix' => 'dashboard', 'as' => 'dashboard.', 'namespace' => 'Admin','middleware' => 'auth'], function () {
    ...
    Route::get('permintaans/{permintaan}/perancangan', [PermintaanController::class, 'perancangan'])->name('permintaans.perancangan');
    ...
    // Pembayaran
    Route::get('perancangans', [PerancanganController::class, 'index'])->name('perancangans.index');
    Route::get('perancangans/create/{permintaan}', [PerancanganController::class, 'create'])->name('perancangans.create');
    ...
    Route::get('perancangans/{perancangan}/edit', [PerancanganController::class, 'edit'])->name('perancangans.edit');
