...
<head>
    ...
    <link href="{{ asset('css/jquery-datatable.css') }}" rel="stylesheet" />
    <link href="{{ asset('css/datatable.bootstrap4.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('css/select.datatable.min.css') }}" rel="stylesheet" />
    ...
    <link rel="icon" href="{{ asset('logo-gustian.jpg') }}" type="image/x-icon">
    @yield('styles')
    <style>
...
<body class="sidebar-mini layout-fixed" style="height: auto;">
    <div class="wrapper">
        <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" data-widget="pushmenu" href="#"><img src="{{ asset('icons/arrow-left-solid.svg') }}" alt="book" width="20px" height="20px">
</a>
                </li>
            </ul>
        ...
        <footer class="main-footer">
            <strong> &copy;</strong> Sistem Informasi Pengelolaan Administrasi Perkara 
        </footer>
    </div>
