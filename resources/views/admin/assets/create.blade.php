...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("dashboard.formulirPendaftarans.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('jenis_kelamin') ? 'is-invalid' : '' }}" name="jenis_kelamin" id="jenis_kelamin" required>
                    ...
                    @foreach($jenis_kelamins as $jenis_kelamin)
                        <option value="{{ $jenis_kelamin['name'] }}" {{ old('jenis_kelamin') == $jenis_kelamin['name'] ? 'selected' : '' }}>{{ $jenis_kelamin['name'] }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('alamat') ? 'is-invalid' : '' }}" type="textarea" name="alamat" id="alamat" value="{{ old('alamat') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nama_keluarga') ? 'is-invalid' : '' }}" type="text" name="nama_keluarga" id="nama_keluarga" value="{{ old('nama_keluarga') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nomor_kartu_keluarga') ? 'is-invalid' : '' }}" type="text" name="nomor_kartu_keluarga" id="nomor_kartu_keluarga" value="{{ old('nomor_kartu_keluarga') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jumlah_anak') ? 'is-invalid' : '' }}" type="text" name="jumlah_anak" id="jumlah_anak" value="{{ old('jumlah_anak') }}">
